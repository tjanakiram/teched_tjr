sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("sunny/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("sunny.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["sunny/localService/mockserver"], function (mockserver) {
