/*global history */
sap.ui.define([
		"sunny/controller/BaseController",
		...
		"sap/ui/Device",
		"sunny/model/formatter",
		"sunny/model/grouper",
		"sunny/model/GroupSortState"
		...
		return BaseController.extend("sunny.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("sunny.view.ViewSettingsDialog", this);
