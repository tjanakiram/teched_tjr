sap.ui.define([
		...
		return BaseObject.extend("sunny.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias sunny.model.ListSelector
			 */
			 ...
			 * @return {sunny.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
